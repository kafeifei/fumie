...
import { AGENT_ALLOW_SESSION_OPTION_ID, type IAgentToolPendingConfirmationSignal } from '../common/agent.js';
...
const ALLOW_SESSION_OPTION_ID = AGENT_ALLOW_SESSION_OPTION_ID;
