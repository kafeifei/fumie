...
import { SessionsTitleBarWorkspaceContribution } from './sessionsTitleBarWorkspaceWidget.js';
...
registerWorkbenchContribution2(SessionsTitleBarWorkspaceContribution.ID, SessionsTitleBarWorkspaceContribution, WorkbenchPhase.BlockRestore);
