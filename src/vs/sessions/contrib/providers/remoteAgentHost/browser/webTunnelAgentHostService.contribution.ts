...
import { ITunnelAgentHostService, type ICachedTunnel, type ITunnelDiscoveryOptions, type ITunnelInfo, type ITunnelUserLimit, type TunnelAutoConnectMode } from '../../../../../platform/agentHost/common/tunnelAgentHost.js';
...
class BrowserTunnelAgentHostServiceSelector extends Disposable implements ITunnelAgentHostService {
	...
	listUserLimits(options?: { silent?: boolean }): Promise<readonly ITunnelUserLimit[] | undefined> {
		return this._delegate.listUserLimits(options);
	}
